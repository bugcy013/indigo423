#!/bin/bash
# Synchronize Ubuntu CD ISO images
#
...
BW_LIMIT=0
RSYNC_PROT=rsync
RSYNC_HOST=ftp-stud.hs-esslingen.de
SRC=ubuntu.releases
DST=/storage/vol2/mirror/ubuntu.releases
RSYNC_OPT="-vazH --delete --group=mirror --owner=mirror"
RSYNC_LOG=/var/www/mirror/pub/log/ubuntu.releases.log
DATE=`date +"%Y-%m-%d %r"`
